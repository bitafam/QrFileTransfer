...
import { formatBytes, triggerFileDownload } from '../utils/chunking';
import {
  Send,
  Download,
  Trash2,
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <h4 className="text-xs sm:text-sm font-semibold text-white truncate dir-ltr">
                      {item.fileName}
                    </h4>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  >
                    {item.role === 'sent' ? (
                      <>
                        ...
                        <span className="hidden xs:inline">ارسال شده</span>
                      </>
                    ) : (
                      <>
                        <Download className="w-3 h-3" />
                        <span className="hidden xs:inline">دریافت شده</span>
                      </>
                    )}
                  </span>
                  ...
                  {item.dataUrl && (
                    <button
                      onClick={() => triggerFileDownload(item.dataUrl!, item.fileName, item.fileType)}
